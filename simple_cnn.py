...
# Fit the model
model.fit_generator(generator=datagen.flow(X_train, y_train, batch_size=32), samples_per_epoch=len(X_train), nb_epoch=epochs, validation_data=(X_valid, y_valid), verbose = 1, show_accuracy = True)
